...
<div class="card bordered z-depth-3" style="margin:0% auto; max-width:400px;">
	...
	<div class="row">
		<div class="col s12 m12 l12">
				...
				<form method="post" action="{{ route('admin.centros.update',$centro) }}" class="col s12">
					...
					<div class="row">
						<div class="input-field	col s12">
							...
							<input type="text" name="name" id="name" value="{{$centro->name}}">
						</div>	
						<div class="input-field col s12">
							<label for="ciudad">Ciudad</label>
							<input type="text" name="ciudad" id="ciudad" value="{{$centro->ciudad}}">
						</div>
